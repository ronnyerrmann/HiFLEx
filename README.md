...
The Package is described in (https://adsabs.harvard.edu/abs/2020PASP..132f4504E).
...
If you publish data using the barycentric correction, please cite (https://github.com/shbhuk/barycorrpy#citation). If you publish radial velocities using [TERRA](https://adsabs.harvard.edu/abs/2012ApJS..200...15A), [SERVAL](http://adsabs.harvard.edu/abs/2017A&A...609A..12Z), or [CERES](https://adsabs.harvard.edu/abs/2017PASP..129c4002B), please cite the packages.
