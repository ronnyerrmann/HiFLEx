...
\title{User Manual for Data Reduction using the HiFLEx package\\ Working version: v0.4.2}
\date{January, 2020}
...
\subsection*{v0.4.2 (not released yet)}
\begin{itemize}\setlength\itemsep{0em}
...
\begin{lstlisting}[style=base]
wget https://github.com/ronnyerrmann/exohspec/archive/v0.4.2.tar.gz
tar -xzvf v*.tar.gz
\end{lstlisting}
