...
\title{User Manual for Data Reduction using the HiFLEx package\\ version: v1.3.6}
\date{May, 2021}
...
\textbf{Extract both chips together (after identifying the order, a dummy order has to be added, don't use background correction):}
\begin{lstlisting}[style=base]
gunzip *.fits.Z
...
\begin{lstlisting}[style=base]
wget https://github.com/ronnyerrmann/HiFLEx/archive/v1.3.5.tar.gz
tar -xzvf v*.tar.gz
\end{lstlisting}
