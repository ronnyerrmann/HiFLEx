...
\subsection*{v1.2.0 (in preparation)}
\begin{itemize}\setlength\itemsep{0em}
  \item Added parameters \verb|pxshift_between_wavesolutions|, \verb|dataset_rv_analysis|, \verb|logging_arc_line_identification_residuals_hist|, \verb|logging_em_lines_bisector|
