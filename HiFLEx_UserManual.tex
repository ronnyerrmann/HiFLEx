...
\title{User Manual for Data Reduction using the HiFLEx package\\ version: v1.2.0}
\date{August, 2020}
...
Brahm et al. 2017\footnote{\url{https://ui.adsabs.harvard.edu/abs/2017PASP..129c4002B}}.
...
\subsection*{v1.3.0 (in preparation)}
