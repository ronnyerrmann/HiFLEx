...
\title{User Manual for Data Reduction using the HiFLEx package\\ version: v1.3.5}
\date{April, 2021}
...
\begin{itemize}\setlength\itemsep{0em}
  ...
  \item New parameter \verb|logging_em_lines_shift| to plot the line shift on the dector.
\end{itemize}
