...
\begin{itemize}
 \item[raw-data filename + \_spec] Blaze corrected spectrum with wavelength solution in IRAF format (wavelength solution without barycentric correction).
...
The data in here is used in order to measure RV with Terra (\url{https://drive.google.com/file/d/1xK-lYghFwpwtdXG9b4IbryYRd102q7So/view}) (work in progress)
