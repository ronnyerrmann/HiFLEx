...
\begin{enumerate}
  ...
  \begin{itemize}[leftmargin=*]\setlength\itemsep{0em}
    ...
    \item Adjust parameter \verb|subframe| to the full CCD size or a subframe, if only part of the CCD should be used. % Small picture showing the orders and wavelength (arrows blue to red)
  \end{itemize}
...
\begin{enumerate}\setlength\itemsep{0em}
 ...
 \item Velocity width to broaden the lines of the binary mask. Can be empty.
\end{enumerate}
