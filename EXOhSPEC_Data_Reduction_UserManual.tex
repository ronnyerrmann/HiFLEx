...
\title{User Manual for Data Reduction of the EXOhSPEC Instrument \\ Working version: V0.2.0}
\date{February, 2018}
...
\begin{itemize}\setlength\itemsep{0em}
  ...
  \item Parameters of a polynomial fit to the trace (given in parameter \verb|polynom_order_apertures|), e.g. 5 values if the trace is fitted with a polynom of order 5.
