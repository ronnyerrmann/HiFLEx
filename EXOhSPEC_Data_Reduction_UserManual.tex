...
The following replacements are necessary in the conf.txt file. This includes the parameters created by \verb|prepare_file_list.py|.
\begin{itemize}\setlength\itemsep{0em}
  \small
...
Afterwards, \verb|reduction_day.py| can run as described above.
